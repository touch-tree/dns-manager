...
class CloudflareService extends Service
{
    ...
    public function __construct(Http $http)
    {
        ...
        $header = $header
            ...
            ->set('Authorization', 'Bearer ' . config('api.token'));
    ...
    public function update_dns_record(string $id, string $name, array $options): array
    {
        ...
        return $this->http->patch(config('api.url') . '/zones/' . $id . '/dns_records/' . $dns_record['id'], $options)->json();
    }
    ...
    {
        return $this->http->get(config('api.url') . '/zones')->json();
    }
    ...
    {
        return $this->http->get(config('api.url') . '/zones/' . $id)->json();
    }
    ...
    {
        return $this->http->post(config('api.url') . '/zones/', $options)->json();
    }
    ...
    {
        return $this->http->patch(config('api.url') . '/zones/' . $id . '/settings/ssl', $options)->json();
    }
    ...
    {
        return $this->http->patch(config('api.url') . '/zones/' . $id . '/settings/always_use_https', $options)->json();
    }
    ...
    {
        return $this->http->patch(config('api.url') . '/zones/' . $id . '/settings/pseudo_ipv4', $options)->json();
    }
    ...
    {
        return $this->http->get(config('api.url') . '/zones/' . $id . '/dns_records')->json();
    }
    ...
    {
        return $this->http->delete(config('api.url') . '/zones/' . $id . '/dns_records/' . $dns_record_id)->json();
    }
    ...
    {
        return $this->http->post(config('api.url') . '/zones/' . $id . '/dns_records', $options)->json();
    }
    ...
    {
        return $this->http->post(config('api.url') . '/zones/' . $id . '/pagerules', $options)->json();
    }
    ...
    {
        return $this->http->get(config('api.url') . '/zones/' . $id . '/pagerules/' . $pagerule_id)->json();
    }
    ...
    {
        return $this->http->get(config('api.url') . '/zones/' . $id . '/pagerules')->json();
    }
    ...
    {
        return $this->http->patch(config('api.url') . '/zones/' . $id . '/pagerules/' . $pagerule_id, $options)->json();
    }
    ...
    {
        return $this->http->delete(config('api.url') . '/zones/' . $id . '/pagerules/' . $pagerule_id)->json();
    }
    ...
    {
        return $this->http->put(config('api.url') . '/zones/' . $id . '/activation_check')->json();
    }
}